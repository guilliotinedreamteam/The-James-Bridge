...
## 2024-10-27 - [NumPy Operations on Python Lists Overhead]
...
**Action:** Always perform these operations on native NumPy arrays before converting them to lists for JSON serialization or other purposes.
