...
class LabelAligner:
    ...
    def align_to_tensor(
        self, df: pd.DataFrame, total_original_samples: int
    ) -> np.ndarray:
        """
        ...
        """
        logger.info(
            "Aligning sparse clinical triggers to dense continuous time-series..."
        )
        ...
        for _, row in df.iterrows():
            ...
            phoneme_id = self.trigger_to_phoneme.get(
                trigger, 0
