...
async def predict_frame(request):
    ...
    try:
        ...
        # Performance optimization: Perform argmax/max on numpy array before converting to list
        # Doing this on a Python list incurs significant overhead due to implicit array conversions
