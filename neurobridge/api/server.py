...
async def predict_frame(request):
    ...
    try:
        ...
        # ⚡ Bolt Optimization: Perform NumPy operations on native array before converting to list
        # to avoid implicit array conversion overhead during real-time inference.
